        ...
        {skeletons.map((index) => (
          ...
          >
            <div className="flex items-center space-x-4">
              <div className="w-12 h-16 bg-dark-tertiary rounded-lg"></div>
              <div className="flex-1">
                <div className="h-4 bg-dark-tertiary rounded w-3/4 mb-2"></div>
                <div className="h-3 bg-dark-tertiary rounded w-1/2 mb-1"></div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {skeletons.map((index) => (
        ...
        >
          {/* Document Preview */}
          <div className="aspect-[8.5/11] bg-dark-tertiary rounded-lg mb-4"></div>
