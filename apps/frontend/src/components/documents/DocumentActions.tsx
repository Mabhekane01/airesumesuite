  ...
  return (
    <div className="relative">
      <button
        ...
        className="p-2 text-dark-text-muted hover:text-text-primary rounded-lg hover:bg-dark-quaternary/50 transition-all duration-200"
      >
      ...
      <AnimatePresence>
        {showMenu && (
          <>
            ...
            >
              <div className="card-dark rounded-lg shadow-dark-xl border border-surface-200/50 backdrop-blur-lg bg-surface-50/95 overflow-hidden">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center space-x-3 px-4 py-3 text-sm transition-all duration-200 hover:bg-dark-quaternary/50 ${action.color} ${
                        index !== actions.length - 1 ? 'border-b border-surface-200/30' : ''
                      }`}
                    >
