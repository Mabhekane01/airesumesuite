  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 overflow-hidden">
        ...
        >
          <div className="bg-surface-50/95 backdrop-blur-xl h-full flex flex-col">
            {/* Header */}
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-1 bg-gray-700/50 rounded-lg p-1">
                  <button
                    ...
                    className="p-1 text-dark-text-muted hover:text-text-primary disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    title="Zoom Out"
                  >
              ...
              {loading ? (
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <span className="text-text-primary font-medium">Loading resume...</span>
                  </div>
                </div>
              ) : resume ? (
