  ...
  return (
    <>
      <motion.header
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className="bg-gray-900/95 backdrop-blur-lg border-b border-dark-border/70 sticky top-0 z-40 overflow-visible"
      >
          ...
          <div className="flex items-center justify-between h-16 overflow-visible">
            ...
            {isAuthenticated && (
              <nav className="hidden md:flex items-center justify-center">
                <div className="flex items-center space-x-2 bg-gray-700/80 backdrop-blur-sm p-1 rounded-full border border-dark-border">
                  {navigation.map((item) => {
            ...
            <div className="flex items-center space-x-4">
                ...
                <>
                  ...
                  <div className="relative">
                    <motion.button
                      ...
                      className="p-2 rounded-full hover:bg-gray-800/60 transition-all duration-300 hover:shadow-glow-sm relative"
                    >
                      <BellIcon className="h-5 w-5 text-dark-text-secondary hover:text-emerald-500 transition-colors" />
                      {/* Notification Badge */}
                      {unreadCount > 0 && (
              ...
              {isAuthenticated && user ? (
                <Menu as="div" className="relative z-50">
                  <Menu.Button className="flex items-center space-x-2 p-2 rounded-full hover:bg-gray-800/60 transition-all duration-300 hover:shadow-glow-sm">
                  ...
                  >
                    <Menu.Items
                      className="absolute right-0 mt-2 w-48 bg-gray-700/95 backdrop-blur-lg rounded-lg shadow-dark-xl border border-dark-border focus:outline-none z-50"
                      style={{ zIndex: 999999 }}
                    >
                      <div className="p-2">
                        <Menu.Item>
                ...
                <div className="flex items-center space-x-3">
                  <motion.button
                    ...
                    className="text-dark-text-secondary hover:text-emerald-500 transition-all duration-300 font-medium"
                  >
                    Sign In
                  </motion.button>
                  <motion.button
