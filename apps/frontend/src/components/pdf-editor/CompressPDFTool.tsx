      ...
      <div className="min-h-screen bg-transparent p-6">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-white/40 backdrop-blur-xl border border-gray-600/30 shadow-2xl mb-6">
          ...
          {/* Main Content */}
          <div className="bg-white/20 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-8">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-white/30 mb-6">
              ...
              <div className="bg-white/30 backdrop-blur-xl border border-gray-600/30 rounded-xl p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center space-x-4">
            <div className={`flex items-center justify-center w-10 h-10 rounded-full ${step >= 1 ? 'bg-slate-600' : 'bg-white/20'} border ${step >= 1 ? 'border-slate-500' : 'border-gray-600/30'} text-white font-bold backdrop-blur-xl`}>
              {step > 1 ? <Check className="w-5 h-5" /> : '1'}
            </div>
            <div className={`w-16 h-1 ${step >= 2 ? 'bg-slate-600' : 'bg-gray-600/30'} rounded`}></div>
            <div className={`flex items-center justify-center w-10 h-10 rounded-full ${step >= 2 ? 'bg-slate-600' : 'bg-white/20'} border ${step >= 2 ? 'border-slate-500' : 'border-gray-600/30'} text-white font-bold backdrop-blur-xl`}>
              {step > 2 ? <Check className="w-5 h-5" /> : '2'}
            </div>
            <div className={`w-16 h-1 ${step >= 3 ? 'bg-slate-600' : 'bg-gray-600/30'} rounded`}></div>
            <div className={`flex items-center justify-center w-10 h-10 rounded-full ${step >= 3 ? 'bg-slate-600' : 'bg-white/20'} border ${step >= 3 ? 'border-slate-500' : 'border-gray-600/30'} text-white font-bold backdrop-blur-xl`}>
          ...
          <div className="space-y-8">
            <div className="bg-white/20 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-8">
              <div className="text-center mb-8">
                ...
                <div className="mt-6 inline-flex items-center gap-6 bg-white/30 backdrop-blur-xl border border-gray-600/20 px-8 py-4 rounded-xl">
                  ...
                  <input
                    ...
                    onChange={handleFileUpload}
                    className="hidden"
                    id="compress-change-file"
                  />
                  <label 
                    htmlFor="compress-change-file" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                {compressionOptions.map((option) => (
                  <div 
                    key={option.level}
                    className={`
                      cursor-pointer transition-all transform hover:scale-105 border-2 rounded-xl p-6 text-center bg-white/20 backdrop-blur-xl
        ...
        {/* Step 3: Processing */}
        {step === 3 && (
          <div className="bg-white/20 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-12 text-center">
        ...
        {step === 4 && (
          <div className="bg-white/20 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-12 text-center">
            ...
            {compressedSize > 0 && (
              <div className="mb-8 p-6 bg-white/30 backdrop-blur-xl border border-gray-600/20 rounded-xl">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button 
                ...
                className="px-8 py-3 rounded-xl bg-white/30 text-white hover:bg-white/50 border border-gray-600/30 hover:border-gray-500/50 transition-all duration-200"
              >
                Start Over
              </button>
            </div>
