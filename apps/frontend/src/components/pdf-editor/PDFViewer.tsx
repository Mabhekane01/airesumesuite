...
export default function PDFViewer({ file, onTextSelect, onSignaturePlace, annotations = [] }: PDFViewerProps) {
  ...
  return (
    ...
    >
      {/* Toolbar */}
      <div className="flex items-center justify-between p-4 border-b border-surface-200 bg-gray-700/60 backdrop-blur-sm rounded-t-xl">
        <div className="flex items-center space-x-2">
          <span className="text-sm text-text-secondary">
            {file.name}
          </span>
          <span className="text-xs text-text-secondary bg-dark-quaternary px-2 py-1 rounded-full">
            {zoom}%
          </span>
          {numPages && (
            <span className="text-xs text-text-secondary bg-dark-quaternary px-2 py-1 rounded-full">
      ...
      {/* Status Bar */}
      <div className="flex items-center justify-between p-2 bg-gray-700/40 rounded-b-xl text-xs text-text-secondary">
