        ...
        {!uploadedPDF && (
          <div className="bg-white/20 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-8">
            <div className="text-center">
              ...
              <div className="mt-8 text-left bg-surface-50/30 rounded-xl p-6 max-w-md mx-auto">
        ...
        {uploadedPDF && (
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white/20 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-6 space-y-4">
                ...
                <div className="pt-4 border-t border-gray-600/20">
                  ...
                  <div className="text-xs font-mono bg-surface-50/50 p-2 rounded text-green-400">
                    {uploadedPDF.fileId}
                  </div>
                </div>
                  ...
                  {changes.length > 0 && (
                    <div className="mt-2 space-y-1 max-h-32 overflow-y-auto">
                      {changes.map((change, index) => (
                        <div key={change.id} className="flex items-center justify-between bg-surface-50/50 rounded p-2 text-xs">
