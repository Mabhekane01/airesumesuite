            ...
            <div className="bg-white/20 backdrop-blur-xl border border-gray-600/20 rounded-2xl p-8">
              ...
              <div className="flex justify-center gap-4 mb-8">
                <button 
                  ...
                  className="px-6 py-3 rounded-lg bg-white/30 text-white hover:bg-white/50 border border-gray-600/30 hover:border-gray-500/50 transition-all duration-200"
                >
                  Select All
                </button>
                <button 
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`
                        ...
                        ${isSelected ? 'bg-slate-600/80' : 'bg-white/60'}
                      `}>
                        Page {pageNum}
                      </div>
