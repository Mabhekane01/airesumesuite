...
export default function ATSCompatibilityChecker({ 
  ...
  return (
    <div className="fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-700 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-y-auto border border-surface-200">
        <div className="sticky top-0 bg-gray-700 border-b border-surface-200 p-6 flex items-center justify-between">
          <div className="flex items-center">
            <ShieldCheckIcon className="w-6 h-6 text-dark-accent mr-2" />
            <h2 className="text-xl font-semibold text-text-primary">ATS Compatibility Analysis</h2>
          </div>
          <button
            onClick={onClose}
            className="text-dark-text-muted hover:text-text-primary transition-colors"
          >
          ...
          {!analysisResult ? (
            <div className="space-y-6">
              ...
              <Card className="card-dark p-4">
                <h4 className="font-medium text-text-primary mb-3">Resume Version to Analyze</h4>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="card-dark p-6">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-medium text-text-primary">Format Score</h4>
                  </div>
                ...
                <Card className="card-dark p-6">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-medium text-text-primary">Content Score</h4>
                  </div>
                  <div className="text-3xl font-bold text-text-primary mb-2">
                ...
                <Card className="card-dark p-6">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-medium text-text-primary">Keyword Match</h4>
                  </div>
                  <div className="text-3xl font-bold text-text-primary mb-2">
              ...
              <Card className="card-dark p-6">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-text-primary mb-2">Job Alignment Assessment</h4>
                    <p className="text-text-secondary mb-3">{analysisResult.verdict.message}</p>
                    <p className="text-sm text-text-secondary bg-surface-50/20 p-3 rounded-lg border border-surface-200">
                      <strong className="text-text-primary">Recommendation:</strong> {analysisResult.verdict.recommendation}
                    </p>
                  </div>
                </div>
              </Card>
