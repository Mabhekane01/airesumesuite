...
export function FileUpload({ onUpload }: FileUploadProps) {
  ...
  return (
    <div className="space-y-4 animate-slide-up-soft">
      <div
        ...
        className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${
          isDragActive
            ...
            : isUploading
            ? 'border-surface-200 bg-surface-50/20 cursor-not-allowed'
      ...
      >
        ...
        {isUploading ? (
          <div className="space-y-4">
            ...
            <div>
              <p className="text-lg font-medium text-text-primary">Uploading and parsing...</p>
          ...
          <div className="space-y-4">
            <div className="mx-auto w-12 h-12 bg-surface-50/20 rounded-full flex items-center justify-center">
              {isDragActive ? (
      ...
      {/* File Type Info */}
      <div className="glass-dark rounded-lg p-4 border border-surface-200">
