          ...
          <div className="flex flex-col xl:grid xl:grid-cols-3 gap-4 lg:gap-6 h-full">
            ...
            <div className="order-1 xl:order-2 xl:col-span-1 space-y-4 xl:sticky xl:top-0">
              ...
              <Card className="card-glass-dark border border-dark-border/50">
                <div className="p-4">
                  <h3 className="text-base sm:text-lg font-semibold text-dark-text-primary mb-4">Enhancement Summary</h3>
                  ...
                  <div className="mt-4">
                    <h4 className="text-sm font-medium text-dark-text-primary mb-2">Added Keywords</h4>
