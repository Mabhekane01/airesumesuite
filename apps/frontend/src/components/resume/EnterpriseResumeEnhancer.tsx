...
export default function EnterpriseResumeEnhancer({
  ...
  const handleSavePdf = useCallback(
    ...
    [savePdfToLibrary, resume, aiData]
  );
      ...
      {activeTab !== "preview" && aiAnalysis && (
        <div className="space-y-4 lg:space-y-6">
          <Card className="card-dark p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-semibold text-dark-text-primary mb-4 sm:mb-6">
              Quick Scores
            </h3>
              ...
              {aiAnalysis ? (
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-lg">
                    ...
                    <p className="text-sm sm:text-base text-dark-text-secondary mb-4 sm:mb-5 leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          {!canUseAI && (
            ...
            <h3 className="text-xl font-semibold text-dark-text-primary mb-2">
              {canUseAI
                ? "Premium Job Optimization"
                : "Premium Feature - Job Optimization"}
            </h3>
            <p className="text-dark-text-secondary mb-4 max-w-md mx-auto">
              {canUseAI
                ? "Automatically optimize your resume for specific job postings using AI-powered analysis and keyword matching."
                : "Upgrade to Enterprise to automatically optimize your resume for specific job postings using AI-powered analysis and keyword matching."}
            </p>
            <div className="flex items-center justify-center gap-6 text-sm text-dark-text-muted mb-4">
              <div className="flex items-center gap-2">
        ...
        <div className="space-y-6">
          ...
          {!canUseAI && (
            <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-dark-text-primary mb-2">
                Premium Feature - Industry Benchmarking
              </h3>
              <p className="text-dark-text-secondary mb-4 max-w-md mx-auto">
