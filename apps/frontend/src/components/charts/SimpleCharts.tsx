...
export const SimpleLineChart: React.FC<LineChartProps> = ({
  ...
  return (
    <div className="w-full h-full bg-white dark:bg-white rounded-lg overflow-hidden p-2 sm:p-4">
      <svg
...
export const SimpleBarChart: React.FC<BarChartProps> = ({
  ...
  return (
    <div className="w-full h-full bg-white dark:bg-white rounded-lg px-3 py-2 sm:px-6 sm:py-4 overflow-x-auto">
