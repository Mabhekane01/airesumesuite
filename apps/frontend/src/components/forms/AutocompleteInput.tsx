...
export const AutocompleteInput: React.FC<AutocompleteInputProps> = ({
  ...
  const getInputClasses = () => {
    ...
    if (showError) {
      ...
      classes += ' border-surface-200 focus:border-dark-accent focus:ring-dark-accent';
    }
  ...
  return (
    <div ref={containerRef} className="relative space-y-1">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 space-x-1">
          ...
          {clearable && value && !loading && (
            <button
              type="button"
              onClick={handleClear}
              className="p-1 text-dark-text-muted hover:text-text-primary rounded"
              tabIndex={-1}
            >
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-1 bg-surface-50 border border-surface-200 rounded-lg shadow-lg max-h-60 overflow-auto">
                ...
                <li
                  ...
                  className={`px-3 py-2 cursor-pointer flex items-center space-x-3 ${
                    highlightedIndex === index
                      ...
                      : 'hover:bg-dark-quaternary/50 text-text-primary'
                  }`}
