...
export default function LocationPermissionModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center z-[60] p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 border border-surface-200">
        <div className="p-6">
          {/* Header */}
          ...
          {showBenefits && (
            <div className="space-y-3 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-text-primary font-medium text-sm">Local Salary Insights</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-text-primary font-medium text-sm">Market Comparisons</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-text-primary font-medium text-sm">Local Job Market</h4>
          ...
          {/* Privacy Note */}
          <div className="bg-surface-50/50 rounded-lg p-3 mb-6">
          ...
          <div className="flex space-x-3">
            <button
              onClick={handleSkip}
              className="flex-1 px-4 py-2 text-text-secondary hover:text-text-primary 
                       border border-surface-200 hover:border-dark-text-muted rounded-lg 
