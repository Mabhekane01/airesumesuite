    ...
    <div className="space-y-6">
          ...
          <div className="lg:col-span-2">
            <Card className="card-dark p-6">
              <div className="flex items-center justify-between mb-4">
                <h4 className="font-semibold text-dark-text-primary">Cover Letter Content</h4>
      ...
      {activeTab === 'analysis' && analysisResult && (
        <div className="space-y-6">
          ...
          <Card className="card-dark p-6 text-center">
            ...
            <h3 className="text-xl font-semibold text-dark-text-primary mb-2">Job Match Score</h3>
            <p className="text-dark-text-secondary">{analysisResult.overallAssessment}</p>
          </Card>
              ...
              <div className="space-y-2">
                {analysisResult.improvementSuggestions?.map((suggestion: string, index: number) => (
                  <div key={index} className="flex items-start">
                    ...
                    <span className="text-sm text-dark-text-secondary">{suggestion}</span>
                  </div>
                ))}
              </div>
            </Card>
      ...
      {activeTab === 'export' && (
        <Card className="card-dark p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h5 className="font-medium text-dark-text-primary">Save to Dashboard</h5>
              <Button
            ...
            <div className="space-y-4">
              <h5 className="font-medium text-dark-text-primary">Download Formats</h5>
              <div className="space-y-2">
          ...
          <div className="flex items-center justify-between">
            ...
            {resumeData && (
              <div className="text-right">
                ...
                <div className="font-medium text-dark-text-primary">{resumeData.title}</div>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="flex items-center justify-center space-x-4">
            {[
              ...
              <div key={item.step} className="flex items-center">
                ...
                <span className="ml-2 text-sm font-medium text-dark-text-primary">{item.label}</span>
