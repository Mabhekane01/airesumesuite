    ...
    >
      <div className="space-y-6">
          ...
          <div className="flex justify-center space-x-3" onPaste={handlePaste}>
            {otp.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-xl font-bold bg-gray-700 border border-surface-200 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
                disabled={isLoading}
              />
            ))}
          </div>
        ...
        <motion.button
          ...
          whileHover={{ scale: isLoading ? 1 : 1.02 }}
          whileTap={{ scale: isLoading ? 1 : 0.98 }}
          className="w-full flex items-center justify-center px-4 py-2 border border-surface-200 text-gray-300 bg-transparent rounded-lg hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <div className="bg-gray-700 border border-surface-200 rounded-lg p-4">
