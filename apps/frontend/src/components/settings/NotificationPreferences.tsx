  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-8">
        ...
        <span className="ml-3 text-dark-text-secondary">Loading preferences...</span>
      </div>
    );
  }
  ...
  if (!preferences) {
    return (
      <div className="text-center p-8">
        ...
        <p className="text-dark-text-secondary">Failed to load notification preferences</p>
        <button
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-medium text-dark-text-primary">Enable Notifications</h4>
          ...
          {/* Channel Preferences */}
          <div>
            <h4 className="font-medium text-dark-text-primary mb-3">Notification Channels</h4>
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <div>
                <h4 className="font-medium text-dark-text-primary flex items-center">
      ...
      >
        ...
        <div className="space-y-6">
          {Object.entries(preferences.categories).map(([category, settings]) => (
            <div key={category} className="border-b border-dark-border pb-6 last:border-b-0">
              <div className="flex items-center justify-between mb-3">
                <div>
