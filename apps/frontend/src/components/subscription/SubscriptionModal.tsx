        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[60] p-4">
            <motion.div
              ...
              className="bg-gray-700/95 backdrop-blur-lg rounded-2xl shadow-dark-2xl border border-surface-200 max-w-md w-full mx-4 overflow-hidden"
            >
              {/* Header */}
              <div className="relative bg-gradient-to-r from-accent-primary/20 to-accent-secondary/20 p-6 border-b border-surface-200">
                <button
                  onClick={onClose}
              ...
              <div className="p-6">
                ...
                <div className="bg-white/50 rounded-lg p-4 mb-6">
                  {loadingPricing ? (
                    <div className="flex items-center justify-center py-4">
                      ...
                      <span className="ml-2 text-sm text-text-secondary">Loading pricing...</span>
                    </div>
                  ) : pricing ? (
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-text-secondary">Starting at</p>
                    ...
                    <div className="text-center py-4">
                      <p className="text-sm text-text-secondary">Pricing unavailable</p>
                ...
                <div className="flex space-x-3">
                  <button
                    onClick={onClose}
                    className="flex-1 px-4 py-2 border border-surface-200 rounded-lg text-text-secondary hover:bg-white/50 transition-colors"
                  >
                    Maybe Later
                  </button>
                  <button
