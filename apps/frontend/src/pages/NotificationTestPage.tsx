  ...
  return (
    <div className="min-h-screen bg-gradient-dark p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Tab Navigation */}
        <div className="mb-8">
          <nav className="flex space-x-1 bg-surface-50/50 p-1 rounded-lg">
            {[
        ...
        {activeTab === 'test' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="space-y-4">
                {/* Current Status */}
                <div className="bg-surface-50/50 p-4 rounded-lg">
                  <h3 className="font-medium text-text-primary mb-2">Current Status</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-text-secondary">Total Notifications:</span>
                      <span className="font-medium text-text-primary">{notifications.length}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="border-t border-surface-200 pt-4">
                  <h3 className="font-medium text-text-primary mb-3">Quick Tests</h3>
            ...
            {stats ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="card-dark text-center">
                  ...
                  <div className="text-text-secondary">Total Notifications</div>
                </div>
                <div className="card-dark text-center">
                  <div className="text-2xl font-bold text-accent-primary">{stats.unread}</div>
                  <div className="text-text-secondary">Unread</div>
                </div>
                <div className="card-dark">
                  <h3 className="font-medium text-text-primary mb-2">By Category</h3>
                  <div className="space-y-1">
                    {Object.entries(stats.byCategory).map(([category, count]) => (
                      <div key={category} className="flex justify-between text-sm">
                        <span className="text-text-secondary capitalize">{category}:</span>
                        <span className="text-text-primary">{count as number}</span>
                      </div>
                    ))}
                  </div>
                </div>
                <div className="card-dark">
                  <h3 className="font-medium text-text-primary mb-2">By Type</h3>
                  <div className="space-y-1">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-text-secondary">Click "Refresh Stats" to load statistics</p>
              </div>
            )}
          </motion.div>
        )}
