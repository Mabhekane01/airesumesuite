    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        ...
        >
          ...
          <div className="bg-gray-700 border border-surface-200 rounded-lg p-4 mb-6">
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="max-w-md w-full bg-surface-50 rounded-xl shadow-2xl border border-surface-200 p-8"
      >
        <button
          onClick={handleGoBack}
          className="flex items-center text-gray-400 hover:text-brand-dark mb-6 transition-colors"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-gray-700 border border-surface-200 rounded-lg text-brand-dark placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
        ...
        <div className="mt-6 bg-gray-700 border border-surface-200 rounded-lg p-4">
