...
export default function EditJobApplication() {
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-text-primary mb-4">Basic Job Information</h3>
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-text-primary mb-4">📄 Resume/CV Management</h3>
        ...
        <div className="border border-surface-200 rounded-lg p-4">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-md font-medium text-text-primary">Select Resume</h4>
            {formData.documentsUsed?.selectedResume && (
              <button
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-text-primary mb-4">Location & Compensation</h3>
        
        {/* Location */}
        <div className="mb-6">
          <h4 className="text-md font-medium text-text-secondary mb-3">Location</h4>
          ...
          <div className="flex items-center space-x-6">
            <label className="flex items-center">
              <input
                ...
                className="rounded border-surface-200 text-dark-accent focus:ring-dark-accent"
              />
              <span className="ml-2 text-sm text-text-primary">Remote Work Available</span>
            </label>
            <label className="flex items-center">
              <input
                type="checkbox"
                ...
                className="rounded border-surface-200 text-dark-accent focus:ring-dark-accent"
              />
              <span className="ml-2 text-sm text-text-primary">Hybrid Options</span>
            </label>
          </div>
        </div>
        ...
        {/* Compensation */}
        <div>
          <h4 className="text-md font-medium text-text-secondary mb-3">Compensation</h4>
          <div className="mb-4">
            <EnhancedSalaryInput
              name="salary"
              label="Salary Range"
          ...
          {/* Benefits */}
          <div>
            <label className="block text-sm font-medium text-text-secondary mb-2">Benefits</label>
    ...
    <div className="space-y-6">
      <div>
        ...
        {(formData.jobSource === 'referral' || formData.applicationMethod === 'referral') && (
          <div className="mt-6 p-4 bg-surface-50/20 rounded-lg border border-surface-200">
            <h4 className="text-md font-medium text-text-secondary mb-3">Referral Contact</h4>
  ...
  const renderStep5 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-text-primary mb-4">Application Strategy</h3>
          ...
          <div>
            ...
            <div className="space-y-2">
              {formData.applicationStrategy.keySellingPoints.map((point, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 bg-surface-50/20 rounded border border-surface-200"
                >
                  <div className="flex items-center space-x-2">
  ...
  if (initialLoading) {
    return (
      <div className="animate-pulse">
        <div className="h-8 bg-surface-50/20 rounded w-1/4 mb-6"></div>
        <div className="space-y-4">
          <div className="h-64 bg-surface-50/20 rounded-lg"></div>
          <div className="h-48 bg-surface-50/20 rounded-lg"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-slide-up-soft">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <button
            ...
            className="p-2 text-dark-text-muted hover:text-text-primary rounded-lg hover:bg-surface-50/20"
          >
            <ArrowLeftIcon className="w-5 h-5" />
          </button>
          <div>
            <h1 className="text-2xl font-bold text-text-primary">Edit Job Application</h1>
            <div className="flex items-center space-x-4">
      ...
      <div className="card-dark rounded-lg border border-surface-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-text-primary">Step {currentStep} of {totalSteps}</h3>
          <span className="text-sm text-text-secondary">{Math.round((currentStep / totalSteps) * 100)}% Complete</span>
        </div>
        <div className="w-full bg-surface-50/20 rounded-full h-2">
          <div
