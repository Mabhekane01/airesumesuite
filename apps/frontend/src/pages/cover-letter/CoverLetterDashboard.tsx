      ...
      <div className="min-h-screen bg-gradient-dark py-4 xs:py-6 sm:py-8 px-2 xs:px-3 sm:px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="animate-pulse">
            <div className="h-6 xs:h-8 bg-surface-50 rounded mb-4 xs:mb-6"></div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-6">
              {[1, 2, 3].map(i => (
                <div key={i} className="h-40 xs:h-48 bg-surface-50 rounded-lg"></div>
              ))}
            </div>
          </div>
        </div>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="min-w-0">
                <h3 className="font-semibold text-text-primary mb-1 text-sm xs:text-base">
                  Conversational AI
                </h3>
                <p className="text-xs xs:text-sm text-text-secondary line-clamp-2">
            ...
            {coverLetters.map((coverLetter) => (
              <Card key={coverLetter._id} className="card-dark p-4 xs:p-5 sm:p-6">
                <div className="mb-3 xs:mb-4">
                  <h3 className="font-semibold text-text-primary mb-2 line-clamp-2 text-sm xs:text-base">
                    {coverLetter.title}
                  </h3>
                  <div className="space-y-1 text-xs xs:text-sm text-text-secondary">
                ...
                <div className="flex flex-col xs:flex-row space-y-2 xs:space-y-0 xs:space-x-2">
                  ...
                  <div className="flex xs:flex-col space-x-2 xs:space-x-0 xs:space-y-0">
                    <div className="relative group flex-1 xs:flex-none">
                      ...
                      {/* Download Dropdown */}
                      <div className="absolute bottom-full right-0 mb-2 hidden group-hover:block bg-surface-50 border border-surface-200 rounded-lg shadow-xl py-2 min-w-[120px] z-50">
                        <button
                          onClick={() => handleDownload(coverLetter._id, 'pdf')}
                          className="block w-full text-left px-4 py-2 text-sm text-text-primary hover:bg-dark-accent/10 transition-colors"
                        >
                          Download PDF
                        </button>
                        <button
