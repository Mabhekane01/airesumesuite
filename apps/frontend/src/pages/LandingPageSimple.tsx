...
const features = [
  {
    ...
    description: 'Create professional resumes with AI-powered optimization for ATS compatibility. Choose from 30+ professional templates.',
  ...
  },
  {
    ...
    description: 'Organize, preview, download, and share all your resumes and cover letters in one centralized dashboard.',
    color: 'from-indigo-500 to-blue-600'
  },
  {
    icon: DocumentArrowUpIcon,
    title: 'PDF Editor Suite',
    description: 'Advanced PDF editing with watermarks, security, digital signatures, form creation, and OCR capabilities.',
    color: 'from-red-500 to-pink-600'
  },
  {
    icon: CpuChipIcon,
    title: 'Job Intelligence Platform',
    description: 'AI-powered job market analysis with multi-source scraping, skill extraction, and salary predictions.',
  ...
  },
  {
    ...
    description: 'Advanced ATS scanning and optimization ensures your resume passes through applicant tracking systems.',
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-dark-text-secondary mb-12 max-w-3xl mx-auto animate-slide-up-soft" style={{ animationDelay: '0.4s' }}>
              Create ATS-optimized resumes from 30+ templates, generate personalized cover letters, manage documents, edit PDFs, and leverage our job intelligence platform. Get hired faster than ever before.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-dark-text-primary">
              Complete Job Search <span className="gradient-text-dark">Platform</span> 🚀
            </h2>
            <p className="text-xl text-dark-text-secondary max-w-3xl mx-auto">
              From AI resume building and document management to PDF editing and job market intelligence - everything you need for a successful career in one platform.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-800/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-slide-up-soft">
              <div>
                <div className="inline-flex items-center gap-2 bg-gray-800/50 backdrop-blur-sm border border-dark-border rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-sm font-medium text-dark-text-secondary">30+ Professional Templates</span>
                </div>
                
                <h2 className="text-4xl md:text-5xl font-bold mb-6 text-dark-text-primary">
                  <span className="gradient-text-dark">AI-Powered</span> Resume Templates
                </h2>
                
                <p className="text-xl text-dark-text-secondary leading-relaxed mb-8">
                  Create stunning, ATS-optimized resumes with our professionally designed templates. Each template is crafted by career experts and enhanced with AI to ensure maximum impact with hiring managers.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">ATS-Optimized Design</h3>
                    <p className="text-dark-text-secondary">Every template passes through Applicant Tracking Systems with 95%+ success rate, ensuring your resume reaches human reviewers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">AI Content Enhancement</h3>
                    <p className="text-dark-text-secondary">Templates work seamlessly with our AI writing assistant to optimize keywords, phrases, and formatting for maximum impact.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">Industry-Specific Options</h3>
                    <p className="text-dark-text-secondary">Choose from templates tailored for tech, finance, healthcare, creative industries, and more. Each designed for specific career paths.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative animate-slide-up-soft" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="relative card-glass-dark p-6 hover:shadow-glow-lg transition-all duration-500 transform group-hover:scale-105 border border-dark-border/50 hover:border-accent-primary/50">
                  <div className="relative overflow-hidden rounded-xl mb-6 bg-white shadow-2xl">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                      <h4 className="text-lg font-semibold text-gray-900 mb-1">Modern Professional</h4>
                      <p className="text-sm text-gray-600">Clean design • ATS-Optimized • AI-Enhanced</p>
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-dark-text-secondary mb-4">
                      Our most popular template combines clean design with ATS optimization
                    </p>
            ...
            <div className="space-y-8 animate-slide-up-soft">
              <div>
                <div className="inline-flex items-center gap-2 bg-gray-800/50 backdrop-blur-sm border border-dark-border rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-sm font-medium text-dark-text-secondary">Coming Soon • In Development</span>
                </div>
                
                <h2 className="text-4xl md:text-5xl font-bold mb-6 text-dark-text-primary">
                  <span className="gradient-text-dark">Job Intelligence</span> Platform
                </h2>
                
                <p className="text-xl text-dark-text-secondary leading-relaxed mb-8">
                  Advanced job market intelligence powered by AI-driven web scraping. Get real-time insights directly from thousands of company career pages and vacancy portals across different countries.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">Direct Company Career Page Scraping</h3>
                    <p className="text-dark-text-secondary">Aggregate job postings directly from thousands of company career pages and corporate vacancy portals across multiple countries in real-time.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">Global Market Intelligence & Analytics</h3>
                    <p className="text-dark-text-secondary">Track hiring trends, salary ranges, emerging skills across different countries and regions. Get competitive intelligence on company-specific hiring patterns.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">AI-Powered Job Matching</h3>
                    <p className="text-dark-text-secondary">Advanced NLP and machine learning algorithms analyze job requirements, extract skills, and provide personalized job recommendations.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-900/30 to-indigo-900/30 backdrop-blur-sm border border-purple-500/20 rounded-xl p-6">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Our Job Intelligence Platform is currently in active development. We're building a comprehensive microservices architecture that directly scrapes thousands of company career pages worldwide, providing unfiltered access to corporate job postings. 
                ...
                <div className="relative card-glass-dark p-6 hover:shadow-glow-lg transition-all duration-500 border border-dark-border/50">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-lg font-semibold text-dark-text-primary">Company Career Intelligence</h3>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                        <span className="text-xs text-dark-text-secondary">Live Scraping</span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-gradient-to-br from-purple-900/30 to-indigo-900/30 rounded-lg p-4">
                        <div className="text-2xl font-bold text-purple-300">8,247</div>
                        <div className="text-xs text-gray-400">Companies Scraped</div>
                      </div>
                      <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-lg p-4">
                        <div className="text-2xl font-bold text-blue-300">52</div>
                    ...
                    <div className="space-y-3">
                      {[
                        { title: 'Senior Software Engineer', company: 'Microsoft Corp', salary: '$165K-$220K', location: 'Seattle, WA', source: 'careers.microsoft.com' },
                        { title: 'Product Manager', company: 'Shopify Inc', salary: '€95K-€125K', location: 'Berlin, Germany', source: 'shopify.com/careers' },
                        { title: 'Data Scientist', company: 'Netflix', salary: '$180K-$250K', location: 'Los Angeles, CA', source: 'jobs.netflix.com' }
                      ].map((job, index) => (
                        <div key={index} className="bg-gray-800/50 rounded-lg p-3 border border-gray-700/50">
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              <h4 className="text-sm font-medium text-dark-text-primary">{job.title}</h4>
                              <p className="text-xs text-dark-text-secondary">{job.company} • {job.location}</p>
                              <p className="text-xs text-purple-400 mt-1">Source: {job.source}</p>
                            </div>
                            <div className="text-xs text-green-400 font-medium">{job.salary}</div>
                          </div>
                        </div>
                      ))}
                    </div>
      ...
      <section className="py-20 bg-gray-800/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative group">
                ...
                <div className="relative card-glass-dark p-6 hover:shadow-glow-lg transition-all duration-500 border border-dark-border/50">
                  <div className="space-y-4">
                    {/* Header */}
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-lg font-semibold text-dark-text-primary">Document Analytics</h3>
                      <div className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-1 rounded">Papermark-like</div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-900/30 to-blue-900/30 rounded-lg p-4 border border-indigo-500/20">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <div className="text-sm font-medium text-dark-text-primary">John_Doe_Resume.pdf</div>
                          <div className="text-xs text-dark-text-secondary">Shared 2 hours ago</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        <div className="text-center">
                          <div className="text-lg font-bold text-indigo-300">24</div>
                          <div className="text-xs text-gray-400">Views</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-blue-300">8</div>
                          <div className="text-xs text-gray-400">Unique Viewers</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-green-300">3m 24s</div>
                      ...
                      <div className="space-y-2">
                        ...
                        {[
                          { viewer: 'HR Manager', time: '10 min ago', duration: '4m 12s' },
                          { viewer: 'Tech Lead', time: '1 hour ago', duration: '2m 45s' },
                          { viewer: 'Recruiter', time: '2 hours ago', duration: '5m 18s' }
                        ].map((activity, index) => (
                          <div key={index} className="flex justify-between items-center text-xs bg-gray-800/50 rounded p-2">
                            <span className="text-dark-text-secondary">{activity.viewer}</span>
                            <span className="text-gray-400">{activity.time}</span>
                            <span className="text-green-400">{activity.duration}</span>
                          </div>
                        ))}
                      </div>
                    </div>
            ...
            {/* Right Content */}
            <div className="space-y-8 animate-slide-up-soft order-1 lg:order-2" style={{ animationDelay: '0.1s' }}>
              <div>
                <div className="inline-flex items-center gap-2 bg-gray-800/50 backdrop-blur-sm border border-dark-border rounded-full px-4 py-2 mb-6">
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6 text-dark-text-primary">
                  Smart <span className="gradient-text-dark">Document Manager</span>
                </h2>
                
                <p className="text-xl text-dark-text-secondary leading-relaxed mb-8">
                  Papermark-inspired document sharing with advanced analytics. Share your resumes and documents securely while tracking viewer engagement, time spent, and detailed analytics.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">Advanced Document Analytics</h3>
                    <p className="text-dark-text-secondary">Track who views your documents, how long they spend on each page, and get detailed engagement metrics like Papermark.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">Secure Document Sharing</h3>
                    <p className="text-dark-text-secondary">Share resumes and portfolios with custom domains, password protection, and expiration dates. Perfect for job applications.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-dark-text-primary mb-2">AI-Powered Insights</h3>
                    <p className="text-dark-text-secondary">Get AI recommendations on document performance, optimal sharing times, and content suggestions based on viewer behavior.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-indigo-900/30 to-blue-900/30 backdrop-blur-sm border border-indigo-500/20 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-indigo-300 font-semibold">Development Status</span>
                </div>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Our Document Manager is being built as an open-source alternative to DocSend and Papermark, with enhanced AI features for job seekers. 
                  <span className="text-indigo-300 font-medium"> Expected launch: Q1 2025</span>
                </p>
              </div>
            </div>
          </div>
