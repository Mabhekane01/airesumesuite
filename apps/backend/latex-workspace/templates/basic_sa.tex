...
\usepackage[margin=1.2cm]{geometry} % Reduced margin for closer border
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{hyperref}
\usepackage{xcolor}
\usepackage{fontawesome5}
\usepackage[most]{tcolorbox} % For thick border
...
% --- THICK BORDER BOX ---
\begin{tcolorbox}[colframe=darkblue,boxrule=2.5pt,arc=0pt,outer arc=0pt, left=8pt, right=8pt, top=8pt, bottom=8pt, enhanced]
