...
\begin{itemize}
    \item[\heartstab] \textbf{BSc in Field of Study from North-West University (Graduation Date):} While successfully completing my degree, I sometimes regret not exploring more interdisciplinary courses.
    \item[\squigarr] This taught me the value of broader knowledge and continuous learning beyond my core specialization.
\end{itemize}
...
\begin{itemize}
    \item[\heartstab] \textbf{Network Engineer \& Software Developer at CMC Networks (2023-07-01 - Present):} Despite achieving 99.9\% uptime on critical monitoring systems, there were instances where initial designs overlooked specific edge cases, leading to reactive adjustments.
    \item[\squigarr] This taught me the importance of exhaustive pre-deployment testing and comprehensive scenario planning to minimize post-launch interventions.
\end{itemize}
...
\SkillsEntry{Java}{Still striving for mastery in advanced Java concurrency and performance optimization.}
\SkillsEntry{C\#}{Continuously improving my understanding of C\# best practices and design patterns.}
\SkillsEntry{Node.js}{Working to deepen my expertise in Node.js asynchronous programming and error handling.}
\SkillsEntry{React.js}{Exploring more complex state management and performance tuning techniques in React.js.}
\SkillsEntry{MongoDB}{Aiming to enhance my skills in MongoDB aggregation pipelines and database scaling.}
