...
\newcommand{\NameEmailPhoneSiteGithub}[5]{ % Corrected macro definition
...
%%% Professional Summary (Added as per user request)
...
\begin{itemize}
    \item \textbf{BSc from North-West University}
\end{itemize}
